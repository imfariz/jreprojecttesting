...
.btn-furnitur__hero-banner {
  color: #fff;
  font-weight: 600;
  background-color: #FA9671;
}
...
.btn__hero-banner {
    color: #fff;
    font-weight: 600;
    background: linear-gradient(267.48deg, #6CA0E0 0.72%, #CF91C6 0.73%, #A55299 93.3%);
}

.btn__content-secondary {
  color: #fff;
  font-weight: 600;
